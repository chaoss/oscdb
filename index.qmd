...
region_colors <- tribble(
  ...
  "North America", "#e84393", # Pink
  "South America", "#00b894", # Mint
  "Europe", "#0984e3",       # Dark Blue
  "Asia Pacific", "#6c5ce7",  # Purple/Blue
...
leaflet() %>%
  ...
  setView(lng = 0, lat = 20, zoom = 2) %>%  # Centered on prime meridian with wider view
